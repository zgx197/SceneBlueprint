...
namespace SceneBlueprint.Editor.Session
{
    ...
    internal sealed class BlueprintEditorSession : IDisposable
    {
        ...
        // ── 序列化工具 ──
        public JsonGraphSerializer CreateGraphSerializer(INodeTypeProvider? typeProvider = null)
            => new JsonGraphSerializer(new ActionNodeDataSerializer(), typeProvider);

        /// <summary>基于当前 Profile 的 NodeTypes 构建反序列化用 TypeProvider（INodeTypeCatalog 已实现 INodeTypeProvider）</summary>
