...
namespace SceneBlueprint.Editor.Templates
{
    ...
    {
        private const string DefaultAssetPath = "Assets/Extensions/SceneBlueprint/Templates/GizmoStyle.asset";
        ...
        private static void EnsureDefaultAsset()
        {
            ...
            // 确保目录存在
            const string dir = "Assets/Extensions/SceneBlueprint/Templates";
            if (!AssetDatabase.IsValidFolder(dir))
            {
                // 逐级创建
                if (!AssetDatabase.IsValidFolder("Assets/Extensions/SceneBlueprint"))
                    AssetDatabase.CreateFolder("Assets/Extensions", "SceneBlueprint");
                AssetDatabase.CreateFolder("Assets/Extensions/SceneBlueprint", "Templates");
            }
