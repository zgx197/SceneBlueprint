...
> 版本：v1.5  
> 日期：2026-02-14  
> 状态：Phase 4B-2 已完成（SceneMarker 体系 + Gizmo 管线 + 绑定系统 + 日志系统 + 标记定义注册表）
...
| [SceneMarker系统设计](SceneMarker系统设计.md) | 场景标记组件、分层可视化、Scene View 右键创建、双向联动、Tag 集成 |
...
| [Gizmo绘制管线设计](Gizmo绘制管线设计.md) | 7阶段绘制管线、MarkerCache、IMarkerGizmoRenderer、视锥裁剪 |
| [数据驱动模板系统设计](数据驱动模板系统设计.md) | ActionTemplateSO、BlueprintTemplateSO、GizmoStyleSO、MarkerPresetSO |
