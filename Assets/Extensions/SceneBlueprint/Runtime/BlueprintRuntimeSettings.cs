...
namespace SceneBlueprint.Runtime
{
    ...
    public class BlueprintRuntimeSettings : ScriptableObject
    {
        ...
        /// <summary>配置文件的资源路径（相对于 Resources 目录）</summary>
        private const string ResourcePath = "SceneBlueprint/SceneBlueprintRuntimeSettings";

        /// <summary>配置文件的完整路径（用于编辑器菜单）</summary>
        public const string AssetPath = "Assets/Extensions/SceneBlueprint/Resources/SceneBlueprintRuntimeSettings.asset";
