...
namespace SceneBlueprint.Tests.Scripts
{
    ...
    public class TestConfiguration : ScriptableObject
    {
...
#if UNITY_EDITOR
            // 首先尝试从项目根目录加载
            var rootConfigPath = "Assets/Extensions/SceneBlueprintUser/Tests/SceneBlueprintTestConfig.asset";
        ...
        {
#if UNITY_EDITOR
            var resourcesPath = "Assets/Extensions/SceneBlueprintUser/Tests/Resources";
